...
export const badgeVariants = cva(
    "inline-flex items-center gap-2 text-xs leading-none py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
    {
        variants: {
            variant: {
                default: "",
