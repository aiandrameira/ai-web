...
export const emptyTitleVariants = cva("text-lg font-semibold font-title text-primary tracking-tight", {
    variants: {},
});

export const emptyDescriptionVariants = cva("text-muted-foreground font-text [&>a:hover]:text-primary text-sm/relaxed [&>a]:underline [&>a]:underline-offset-4", {
    variants: {},
});
