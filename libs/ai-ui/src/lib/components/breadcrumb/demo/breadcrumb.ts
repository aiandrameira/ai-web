...
export const BREADCRUMB = {
    ...
    examples: [
        {
            name: "default",
            component: DemoBreadcrumbDefaultComponent,
        },
        {
            name: "content",
            component: DemoBreadcrumbContentComponent,
        },
        {
            name: "router-link",
            component: DemoBreadcrumbRouterLinkComponent,
        },
        {
            name: "icon",
            component: DemoBreadcrumbIconComponent,
        },
        {
            name: "directive",
            component: DemoBreadcrumbDirectiveComponent,
        },
        {
            name: "custom-separator",
            component: DemoBreadcrumbCustomSeparatorComponent,
        },
    ],
};
