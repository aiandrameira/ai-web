...
export const FLOAT_BUTTON = {
    ...
    examples: [
        { name: "variant", component: DemoFloatButtonVariantComponent },
        { name: "shape", component: DemoFloatButtonShapeComponent },
        { name: "size", component: DemoFloatButtonSizeComponent },
        { name: "position", component: DemoFloatButtonPositionComponent },
        { name: "float-group", component: DemoFloatButtonGroupComponent },
        { name: "float-top", component: DemoFloatButtonTopComponent },
    ],
};
